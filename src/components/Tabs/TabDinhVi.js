...
import { urlGetLocate, urlDeleteLocate } from "../url";
...
function TabDinhVi() {
    ...
    const TaiDuLieu = () => {
        dispatch({ type: 'SET_LOADING', payload: true })
        fetch(`${urlGetLocate}?page=${dataUser.page}&limit=${dataUser.limit}&sortBy=${dataUser.sortBy}&sortOrder=${dataUser.sortOrder}&search=${dataUser.search}&searchBy=${dataUser.searchBy}&searchExact=${dataUser.searchExact}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'ss': getCookie('ss'),
                    ...
                    <div>
                        ...
                        <div style={{ 'display': "inline-block", float: 'right' }}>
                            ...
                            <select class="form-select-sm" value={dataUser.searchBy} onChange={handleSearchBy}>
                                ...
                                <option value="LanMuaDinhVi">Tìm theo Lần Mua Định Vị</option>
                                <option value="NgayMua">Tìm theo Ngày Mua</option>
                                <option value="NgayHetHan">Tìm theo Ngày Hết Hạn</option>
                                <option value="ThoiGian">Tìm theo Thời Gian Hiệu Lực</option>
                                <option value="NguoiMuaDinhVi">Tìm theo Người Mua Định Vị</option>
