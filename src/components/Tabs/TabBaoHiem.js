                        ...
                        <div style={{
                            ...
                            <div style={{ marginTop: '1rem', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', width: '70%' }}>
                                <div style={{ marginRight: '2rem' }}>
                                    ...
                                    <label style={{ borderTop: '1px solid black', color: 'darkgray' }} >Đang hiển thị: {duLieuHienThi.length}/{dataRes.totalItems} | Sắp xếp{dataRes.sortBy === "NgayMuaBaoHiem" || dataRes.sortBy === "NgayHetHan" ?
