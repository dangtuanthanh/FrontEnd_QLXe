...
import { urlGetCar, urlInsertRegistry, urlGetRegistry, urlUpdateRegistry } from "../url"

const Them_suaDangKiem = (props) => {
    //xử lý redux
    ...
    useEffect(() => {
        ...
        if (props.iDAction) {
            ...
            const fetchGetAccount = fetch(`${urlGetRegistry}?id=${props.iDAction}&id2=${props.iDAction2}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'ss': getCookie('ss'),
            ...
            Promise.all([fetchGetRole, fetchGetAccount])
                ...
                .then(data => {
                    ...
                    if (props.isInsert === false) {
                        let DuLieu = data[1];
                        const dateParts = DuLieu.NgayDangKiem.split('/');
                                    ...
                                    <div className={`${isMobile ? 'col-12' : 'col-6 '}`}>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                value={dataReq.NgayDangKiem}
                                            />
                                        </div>
                                        <div className="form-group">
                                            <label>Thời Gian Đăng Kiểm (Tháng)</label>
                                            <input
                                                type="number"
                                                className="form-control"
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                onChange={(event) => {
                                                    setDataReq({
                                                        ...dataReq,
                                                        NoiDangKiem: event.target.value
                                                    });
                                                }}
                                                value={dataReq.NoiDangKiem}
                                            />
                                        </div>
                                        <div className="form-group">
                                            <label>Người Đi Đăng Kiểm</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                                onChange={(event) => {
                                                    setDataReq({
                                                        ...dataReq,
                                                        NguoiDiDangKiem: event.target.value
                                                    });
                                                }}
                                        ...
                                        {!props.isInsert &&
                                            <div className="form-group" style={{ pointerEvents: !props.isInsert && 'none', opacity: !props.isInsert && '0.5' }}>
                                                ...
                                                <input
                                                    type="number"
                                                    className="form-control"
                                                    value={dataReq.LanDangKiem}
                                                    onChange={(event) => {
                                                        setDataReq({
                                                            ...dataReq,
                                                            LanDangKiem: event.target.value
                                                        });
                                                    }}
                                                />
                                            </div>
...
export default Them_suaDangKiem;