...
import { urlGetCar, urlInsertLocate, urlGetLocate, urlUpdateLocate } from "../url"

const Them_suaDinhVi = (props) => {
    //xử lý redux
    ...
    useEffect(() => {
        ...
        if (props.iDAction) {
            ...
            const fetchGetAccount = fetch(`${urlGetLocate}?id=${props.iDAction}&id2=${props.iDAction2}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'ss': getCookie('ss'),
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="row" style={{ marginTop: '2%' }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center' }}>
                                        ...
                                        <div className="form-group">
                                            <label>Thời Gian Định Vị (Tháng)</label>
                                            <input
                                                type="number"
                                                className="form-control"
